...
"""See docstring for URLDownloaderImproved class"""
...
__all__ = ["URLDownloaderImproved"]


class URLDownloaderImproved(URLGetter):
    ...
    input_variables = {
        ...
        "prefetch_filename": {
            ...
            "required": False,
            "description": (
                "If True, URLDownloaderImproved attempts to determine filename from HTTP "
...
if __name__ == "__main__":
    PROCESSOR = URLDownloaderImproved()
